...
namespace LookingForChars.Tests
{
    ...
    public class CharsCounterTests
    {
        ...
        public int GetCharsCountParametersAreValidReturnsResult(string str, char[] chars)
        {
            // Act
        ...
        public int GetCharsCountParametersAreValid_ReturnsResult(string str, char[] chars, int startIndex, int endIndex)
        {
            // Act
